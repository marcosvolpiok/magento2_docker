...
-- Tiempo de generación: 28-03-2019 a las 10:50:16
...
(1, 'admin', 'admin', 'todopago@gmail.com', 'admin', 'c4069912285159fffa138708dc0c48bf6c60adaebaa615824ab07a66d7c3056f:XGql2Dqj7CIBivLBeRDxnKKfueti7xqe:1', '2019-03-27 21:09:54', '2019-03-28 13:50:01', '2019-03-28 13:28:30', 2, 0, 1, '{\"configState\":{\"payment_us_todopago\":\"1\"}}', NULL, NULL, 'en_US', 0, NULL, NULL, NULL);
...
--
ALTER TABLE `admin_user_session`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Entity ID', AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `core_config_data`
  MODIFY `config_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Config Id', AUTO_INCREMENT=25;
--
